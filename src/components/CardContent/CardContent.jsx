...
export default function Content() {
    ...
    useEffect(() => {
        ...
        let ctx = gsap.context(() => {
            ...
            tl.from(card1 , { overwrite: "auto", x: 400, opacity: 0, scale: 0, force3D: true }, "0.1")
            tl.to(card1 , { scale: 6, x: -2000, y: -400, ease: Linear.easeInOut, display: 'none' })

            tl.from(card2 , { overwrite: "auto", x: -400, opacity: 0, scale: 0, force3D: true }, "0.6")
            tl.to(card2 , { scale: 6, x: 2000, y: 400, ease: Linear.easeInOut, display: 'none'})

            tl.from(card3 , { overwrite: "auto", x: 400, opacity: 0, scale: 0, force3D: true }, "1.2")
            tl.to(card3 , { scale: 6, x: -2000, y: -400, autoAlpha: 0, ease: Linear.easeInOut, display: 'none'})

            tl.from(card4 , { overwrite: "auto", x: -400 ,opacity: 0, scale: 0, force3D: true}, "1.8")
            tl.to(card4 , { scale: 6, x: 2000, y: 400, autoAlpha: 0, ease: Linear.easeInOut })
            // tl.to(card4 , { scale: 1.2 ,ease: Linear.easeInOut })

            tl.from(card5 , { overwrite: "auto", x: 400, opacity: 0, scale: 0, force3D: true }, "2.4")
            tl.to(card5 , { scale: 6, x: -2000, y: -400, autoAlpha: 0, ease: Linear.easeInOut })
                ...
                <div className="card-container">
                    <div className="card">
                        <div className="card-header">
                            <img src={PredatorImg} alt="card_img" />
                            <p>Simple Todo-list</p>
                            <p>Year of productions</p>
                        </div>
                    </div>
                </div>
                <div className="card-container">
                ...
                <div className="card-container">
                    <div className="card">
                        <div className="card-header">
                            ...
                            <p>Work at STECH Technology & Engineering from Jun 2022 to March - 2023</p>
                        </div>
                    </div>
                </div>
            </div>
